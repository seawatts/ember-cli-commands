...
module.exports = {
  ...
  run(options) {
    ...
    targetPromise = targetPromise.then(resolveVersion.bind(this));
    ...
    return targetPromise.then((emberCliTarget) => {
      ...
      return fetchAllDependencies.call(this, localPkg, localCliVersion, emberCliTarget, isAddon, verbose)
